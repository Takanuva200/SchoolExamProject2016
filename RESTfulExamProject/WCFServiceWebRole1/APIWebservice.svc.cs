...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "APIWebservice" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select APIWebservice.svc or APIWebservice.svc.cs at the Solution Explorer and start debugging.
    public class APIWebservice : IAPIWebservice
    {
        ...
        public Ads GetSpecificAd(string id)
        {
        ...
        public MovementSensor GetSpecificMovementSensor(string id)
        {
        ...
        public MovementSensorToAds GetSpecficMovementSensorToAds(string id)
        {
        ...
        public Ads UpdateAdvertisment(string id, Ads newUpdatedAd)
        {
            var updateAd =
                "UPDATE ADS set Address=@updatedAddress, owner=@updatedOwner, dateOfExpire = @updateddateOfExpire where ADS_ID=" +
                id;
            using (var sqlConnection = new MySqlConnection(myConnectionString))
            {
                sqlConnection.Open();
        ...
        public MovementSensor UpdateMSensor(string id, MovementSensor newSensor)
        {
        ...
        public MovementSensorToAds UpdateMsToAd(string id, MovementSensorToAds newMsAds)
        {
        ...
        public void DeleteSpecificAd(string id)
        {
        ...
        public void DeleteSpecificSensor(string id)
        {
        ...
        public void DeleteSpecificSensorToAd(string id)
        {
